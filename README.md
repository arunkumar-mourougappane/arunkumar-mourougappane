...
- **[rover-esp32-control-server](https://github.com/arunkumar-mourougappane/rover-esp32-control-server)** & **[client](https://github.com/arunkumar-mourougappane/rover-esp32-control-client)**: A web-based rover controller setup.
- **[esp32-wifi-utility](https://github.com/arunkumar-mourougappane/esp32-wifi-utility)**: Production-ready WiFi analysis and management platform with real-time spectrum analysis.
- **[gjallarhorn-rs](https://github.com/arunkumar-mourougappane/gjallarhorn-rs)**: A Rust-based system resource monitoring application using Slint UI.
- **[rperf3-rs](https://github.com/arunkumar-mourougappane/rperf3-rs)**: A network throughput measurement tool written in Rust, inspired by iperf3.
- **[emby-assistant](https://github.com/arunkumar-mourougappane/emby-assistant)**: A desktop assistant UI to manage Emby server.
- **[mesh-sense](https://github.com/arunkumar-mourougappane/mesh-sense)**: An ESP32-based WiFi Mesh Sensor Network.
- **[ast-space-mobile-telemetry](https://github.com/arunkumar-mourougappane/ast-space-mobile-telemetry)**: Tracking AST Space Mobile satellites.
